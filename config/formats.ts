...
export const Formats: import('../sim/dex-formats').FormatList = [
	...
	},
	{
		...
		banlist: [
			...
			'Genesect-Chill', 'Genesect-Douse', 'Genesect-Shock', 'Gengar-Mega', 'Giratina', 'Giratina-Origin', 'Gouging Fire', 'Groudon',
			'Groudon-Primal', 'Ho-Oh', 'Iron Bundle', 'Kangaskhan-Mega', 'Koraidon', 'Kyogre', 'Kyogre-Primal', 'Kyurem-Black',
			'Kyurem-White', 'Landorus', 'Lucario-Mega', 'Lugia', 'Lunala', 'Magearna', 'Marshadow', 'Metagross-Mega',
			'Mewtwo', 'Mewtwo-Mega-X', 'Mewtwo-Mega-Y', 'Miraidon', 'Naganadel', 'Necrozma-Dawn-Wings', 'Necrozma-Dusk-Mane', 'Necrozma-Ultra',
			'Ogerpon-Hearthflame', 'Palafin', 'Palkia', 'Palkia-Origin', 'Pheromosa', 'Rayquaza', 'Rayquaza-Mega', 'Reshiram',
			'Salamence-Mega', 'Shaymin-Sky', 'Sneasler', 'Solgaleo', 'Spectrier', 'Terapagos-Stellar', 'Ursaluna-Bloodmoon', 'Urshifu',
			'Walking Wake', 'Xerneas', 'Yveltal', 'Zacian', 'Zacian-Crowned', 'Zamazenta-Crowned', 'Zekrom', 'Zygarde',
			'Zygarde-Complete',
