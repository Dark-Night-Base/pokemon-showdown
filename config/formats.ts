...
export const Formats: FormatList = [
	...
	},
	{
		...
		mod: 'moveitemability',
		// debug: true,
		ruleset: ['[Gen 9] National Dex BH', 'Multi-hit Moves Clause', 'MIA Move Legality', 'MIA Clause = Normal', '!Ability Clause'],
		banlist: [
	...
	},
	{
		...
		banlist: [
			...
			'Comatose + Sleep Talk',
			'Double Iron Bash', 'Final Gambit', 'Imprison', 'Rage Fist', 'Revival Blessing', 'Shed Tail',
