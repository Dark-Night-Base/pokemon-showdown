export const Items: {[k: string]: ModdedItemData} = {
	...
	blueorb: {
		inherit: true,
		onSwitchIn(pokemon) {
			if (pokemon.isActive && (!pokemon.species.isPrimal || pokemon.m.originalSpecies === 'Groudon-Primal')) {
	...
	redorb: {
		inherit: true,
		onSwitchIn(pokemon) {
			if (pokemon.isActive && (!pokemon.species.isPrimal || pokemon.m.originalSpecies === 'Kyogre-Primal')) {
				this.queue.insertChoice({pokemon, choice: 'runPrimal'});
			}
		},
		onPrimal(pokemon) {
